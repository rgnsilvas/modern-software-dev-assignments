...
You must strictly use ONLY the provided context to generate your answer.
Do not invent endpoints, headers, or base URLs.
If the context is missing required information, do not guess.
