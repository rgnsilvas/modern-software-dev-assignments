...
Your task is to call the correct tool to list every top-level function
and its return type from this current Python file.

Use this tool:
- output_every_func_return_type

If the tool requires a file_path, pass an empty string "".
